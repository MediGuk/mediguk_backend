...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
  ...
  protected void doFilterInternal(
    ...
    try {
      ...
      sendErrorResponse(response, "TOKEN_EXPIRED", "Tu sesión ha caducado, camarada.");
      return;
    } catch (JwtException e) {
      sendErrorResponse(response, "INVALID_TOKEN", "El token no es válido.");
      return;
    } catch (Exception e) {
      sendErrorResponse(response, "AUTH_ERROR", "Error en la autenticación.");
      return;
    }
